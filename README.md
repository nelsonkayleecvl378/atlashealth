...
1. **Clone the Repository**:
   ```bash
   git clone https://github.com/amil3955/aegis-health-poc.git
   ```
...
MRP is built with Solidity smart contracts, handling the core functionality of record management and appointment booking:
